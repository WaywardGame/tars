...
export declare enum TarsTranslation {
    ...
    DialogLabelDeity = 124,
    DialogLabelNPC = 125,
    DialogLabelPlayer = 126,
    DialogLabelRecoverThresholds = 127,
    DialogLabelTerrain = 128,
    DialogLabelPlanningAccuracy = 129,
    DialogModeGardener = 130,
    DialogModeGardenerTooltip = 131,
    DialogModeHarvester = 132,
    DialogModeHarvesterTooltip = 133,
    DialogModeQuest = 134,
    DialogModeQuestTooltip = 135,
    DialogModeSurvival = 136,
    DialogModeSurvivalTooltip = 137,
    DialogModeTerminator = 138,
    DialogModeTerminatorTooltip = 139,
    DialogModeTidyUp = 140,
    DialogModeTidyUpTooltip = 141,
    DialogModeAngler = 142,
    DialogModeAnglerTooltip = 143,
    DialogModeTreasureHunter = 144,
    DialogModeTreasureHunterTooltip = 145,
    DialogButtonNone = 146,
    DialogButtonDeityNoneTooltip = 147,
    DialogButtonGood = 148,
    DialogButtonDeityGoodTooltip = 149,
    DialogButtonNeutral = 150,
    DialogButtonDeityNeutralTooltip = 151,
    DialogButtonEvil = 152,
    DialogButtonDeityEvilTooltip = 153
}
