...
export declare enum TarsTranslation {
    ...
    DialogLabel = 94,
    DialogRangeRecoverHealthThreshold = 95,
    DialogRangeRecoverHealthThresholdTooltip = 96,
    DialogRangeRecoverStaminaThreshold = 97,
    DialogRangeRecoverStaminaThresholdTooltip = 98,
    DialogRangeRecoverHungerThreshold = 99,
    DialogRangeRecoverHungerThresholdTooltip = 100,
    DialogRangeRecoverThirstThreshold = 101,
    DialogRangeRecoverThirstThresholdTooltip = 102,
    DialogLabelAdvanced = 103,
    DialogLabelCreature = 104,
    DialogLabelDeveloper = 105,
    DialogLabelDoodad = 106,
    DialogLabelGeneral = 107,
    DialogLabelIsland = 108,
    DialogLabelItem = 109,
    DialogLabelItemProtection = 110,
    DialogLabelMultiplayer = 111,
    DialogLabelNPC = 112,
    DialogLabelPlayer = 113,
    DialogLabelRecoverThresholds = 114,
    DialogLabelTerrain = 115,
    DialogLabelPlanningAccuracy = 116,
    DialogModeGardener = 117,
    DialogModeGardenerTooltip = 118,
    DialogModeHarvester = 119,
    DialogModeHarvesterTooltip = 120,
    DialogModeQuest = 121,
    DialogModeQuestTooltip = 122,
    DialogModeSurvival = 123,
    DialogModeSurvivalTooltip = 124,
    DialogModeTerminator = 125,
    DialogModeTerminatorTooltip = 126,
    DialogModeTidyUp = 127,
    DialogModeTidyUpTooltip = 128,
    DialogModeTreasureHunter = 129,
    DialogModeTreasureHunterTooltip = 130
}
