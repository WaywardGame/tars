...
export declare class ItemUtilities {
    ...
    isAllowedToUseItem(context: Context, item: Item, allowInventoryItems?: boolean): boolean;
    ...
    getItemInContainerByGroup(context: Context, container: IContainer, itemTypeGroup: ItemTypeGroup): Item | undefined;
